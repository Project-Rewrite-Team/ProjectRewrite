...
public class ModItems {
    ...
    public static final Item YUCCA_PALM_SIGN = registerItem("yucca_palm_chest_boat", new SignItem(new FabricItemSettings().group(ModItemGroup.PROJECT_REWRITE).maxCount(16), ModBlocks.YUCCA_PALM_SIGN, ModBlocks.YUCCA_PALM_WALL_SIGN));
